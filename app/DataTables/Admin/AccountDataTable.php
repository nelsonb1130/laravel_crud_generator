...
class AccountDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'amount' => new Column(['title' => __('models/accounts.fields.amount'), 'data' => 'amount']),
            'description' => new Column(['title' => __('models/accounts.fields.description'), 'data' => 'description']),
            'created_date' => new Column(['title' => __('models/accounts.fields.created_date'), 'data' => 'created_date'])
        ];
    }
